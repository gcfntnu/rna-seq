...
def argparser():
    ...
    parser.add_argument('--feature-info', help='Optional sample sheet. Will subset expr table if needed', dest='features')
    parser.add_argument('-o ', '--output', default='pca_mqc.png', help='Output filename. Will default to pca.png')
